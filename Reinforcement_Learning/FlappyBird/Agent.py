...
class Agent:
    ...
    def run(self, is_training=True, render = False):
        ...
        for episode in itertools.count():
            ...
            print(f"for episode={episode+1} with total reward = {episode_reward} & epsilon={epislon}")
            
            if is_training:
                epislon = max(epislon * self.epsilon_decay, self.epsilon_min)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = "Train or test modal")
